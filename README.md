...
- มือซ้าย C3–B3 — คีย์ขาว: `Q W E R T Y U`, คีย์ดำ: `2 3 5 6 7`
- มือขวา C4–B4 — คีย์ขาว: `V B N M , . /`, คีย์ดำ: `G H K L ;`
- ค้างเสียง: `Space`
- เปลี่ยนอ็อกเทฟ: `↑` / `↓`
- เริ่มหรือหยุดบันทึก: `Z`
- เปิดหรือปิดเมโทรนอม: `X`

ตัวควบคุมบนหน้าจอรองรับการเปลี่ยนเสียง ปรับระดับเสียง เลื่อนอ็อกเทฟ เปิด sustain (เสียงค้างประมาณ 2 วินาทีหลังปล่อยคีย์) บันทึก และเล่นผลงานซ้ำ

กด **KEY MAP** ด้านซ้ายบนเพื่อตั้งปุ่มได้ครบทุกโน้ตทั้ง 88 คีย์ (A0–C8), Sustain, การเลื่อนอ็อกเทฟ, การบันทึก และเมโทรนอม ช่องที่แสดง `—` ยังไม่ได้กำหนดปุ่ม คลิกช่องแล้วกดปุ่มใหม่ หรือกด `Backspace`/`Delete` เพื่อล้างค่า การตั้งค่าจะถูกจดจำไว้สำหรับการเปิดโปรแกรมครั้งถัดไป

เมโทรนอมรองรับความเร็ว 40–220 BPM, จังหวะ 2/4, 3/4, 4/4 และ 6/8 พร้อม Tap Tempo และเสียงเน้นจังหวะแรก กด `X` เพื่อเปิดหรือปิดได้ และสามารถเปลี่ยนปุ่มนี้จากหน้าตั้งค่าปุ่ม
